...
import com.example.messagelogin.HomeFragment;
...
public class Owner_Homepage_Bottom_Nav extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.menuMessages:
                    Intent intent = new Intent(getApplicationContext(), Owner_Messages.class);
